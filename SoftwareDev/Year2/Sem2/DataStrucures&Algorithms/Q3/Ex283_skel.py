...
def sortEvent():
    ...
    entry5.insert(END, 'Completed')

list = [2,59,7,88,9, 11,102,22,27,28,29,34,55,60,61,65,68,71,73,75,77,8,89,9,96]
a1=MyList(list)


label1 = Label(window, text="SortApplication", fg="blue",bg="yellow", font=("arial", 16, "bold"))   #
...
button5= Button(window, text="Perform selSort", fg="black", font=("arial", 12, "bold"), command=sortEvent)
