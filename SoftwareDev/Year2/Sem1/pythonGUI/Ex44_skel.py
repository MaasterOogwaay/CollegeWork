...
button1 = Button(frame, text="StepUp", fg="black", font=("arial", 10, "bold"), command=step)
button1.grid(row=1, column=0, sticky=W+E)

button2 = Button(frame, text="StepDown", fg="black", font=("arial", 10, "bold"), command=step_down)
button2.grid(row=2, column=0, sticky=W+E)

button3 = Button(frame, text="Set", fg="black", font=("arial", 10, "bold"), command=set_num)
button3.grid(row=3, column=0, sticky=W+E)
...
list2 = ['0', '1', '2']
setVar = StringVar()
combo3 = OptionMenu(frame, setVar, *list2)
setVar.set("0")
