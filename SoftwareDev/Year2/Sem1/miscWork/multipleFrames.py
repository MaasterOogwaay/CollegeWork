...
menu1.add_command(label="Driver Standings",  font=("arial", 12, "bold"), command=change_to_greet)   # menu item
menu1.add_command(label="Leaderboard", font=("arial", 12, "bold"), command=change_to_order)
# =====| End of Menus |=====
